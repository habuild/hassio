...
CONFIG_LOCALBTADDRESS="$(bashio::config '.LocalBTAddress')"
CONFIG_PASSWORD="$(bashio::config '.Password')"
CONFIG_MSI_ENABLED="$(bashio::config '.MIS_Enabled')"
CONFIG_PLANTNAME="$(bashio::config '.Plantname')"
CONFIG_OUTPUTPATH="$(bashio::config '.OutputPath')"
CONFIG_OUTPUTPATHEVENTS="$(bashio::config '.OutputPathEvents')"
CONFIG_LATITUDE="$(bashio::config '.Latitude')"
CONFIG_LONGITUDE="$(bashio::config '.Longitude')"
CONFIG_CALCULATEMISSINGSPOTVALUES="$(bashio::config '.CalculateMissingSpotValues')"
#  CONFIG_DATETIMEFORMAT="$(bashio::config '.DateTimeFormat')"
CONFIG_DATEFORMAT="$(bashio::config '.DateFormat')"
CONFIG_DECIMALPOINT="$(bashio::config '.DecimalPoint')"
CONFIG_TIMEFORMAT="$(bashio::config '.TimeFormat')"
CONFIG_SYNCHTIME="$(bashio::config '.SynchTime')"
CONFIG_SYNCHTIMELOW="$(bashio::config '.SynchTimeLow')"
CONFIG_SYNCHTIMEHIGH="$(bashio::config '.SynchTimeHigh')"
CONFIG_SUNRSOFFSET="$(bashio::config '.SunRSOffset')"
CONFIG_LOCALE="$(bashio::config '.Locale')"
CONFIG_TIMEZONE="$(bashio::config '.Timezone')"
CONFIG_BTCONNECTRETRIES="$(bashio::config '.BTConnectRetries')"
CONFIG_CSV_EXPORT="$(bashio::config '.CSV_Export')"
CONFIG_CSV_EXTENDEDHEADER="$(bashio::config '.CSV_ExtendedHeader')"
CONFIG_CSV_HEADER="$(bashio::config '.CSV_Header')"
CONFIG_CSV_SAVEZEROPOWER="$(bashio::config '.CSV_SaveZeroPower')"
CONFIG_CSV_DELIMITER="$(bashio::config '.CSV_Delimiter')"
CONFIG_CSV_SPOT_TIMESOURCE="$(bashio::config '.CSV_Spot_TimeSource')"
CONFIG_CSV_SPOT_WEBBOXHEADER="$(bashio::config '.CSV_Spot_WebboxHeader')"
CONFIG_SQL_DATABASE="$(bashio::config '.SQL_Database')"
CONFIG_SQL_HOSTNAME="$(bashio::config '.SQL_Hostname')"
CONFIG_SQL_PORT="$(bashio::config '.SQL_Port')"
CONFIG_SQL_USERNAME="$(bashio::config '.SQL_Username')"
CONFIG_SQL_PASSWORD="$(bashio::config '.SQL_Password')"
CONFIG_MQTT_PUBLISHER="$(bashio::config '.MQTT_Publisher')" 
...
CONFIG_MQTT_ITEMDELIMITER="$(bashio::config '.MQTT_ItemDelimiter')"
